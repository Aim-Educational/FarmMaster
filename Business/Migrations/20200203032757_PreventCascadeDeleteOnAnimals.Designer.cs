...
namespace Business.Migrations
{
    ...
    [Migration("20200203032757_PreventCascadeDeleteOnAnimals")]
    partial class PreventCascadeDeleteOnAnimals
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Business.Model.AnimalGroup", b =>
                {
            ...
            modelBuilder.Entity("Business.Model.AnimalGroupScriptAutoEntry", b =>
                {
                    b.Property<int>("AnimalGroupScriptAutoEntryId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("AnimalGroupScriptAutoEntryId");

                    b.HasIndex("AnimalGroupId");

                    b.HasIndex("AnimalGroupScriptId");

                    b.ToTable("AnimalGroupScriptAutoEntries");
                });
            ...
            modelBuilder.Entity("Business.Model.ContactUnsubscribeEntry", b =>
                {
                    b.Property<int>("ContactUnsubscribeEntryId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("ContactUnsubscribeEntryId");

                    b.HasIndex("ContactId");

                    b.ToTable("ContactUnsubscribeEntries");
                });

            modelBuilder.Entity("Business.Model.ContactUnsubscribeToken", b =>
                {
                    b.Property<int>("ContactUnsubscribeTokenId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("ContactUnsubscribeTokenId");

                    b.ToTable("ContactUnsubscribeTokens");
                });
            ...
            modelBuilder.Entity("Business.Model.EnumRolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "Create Life Event Entries",
                        ...
                        new
                        {
                            EnumRolePermissionId = 27,
                            Description = "Create Animal Groups",
                            InternalName = "create_animal_groups"
                        },
                        new
                        {
                            EnumRolePermissionId = 28,
                            Description = "Delete Animal Groups",
                            InternalName = "delete_animal_groups"
                        },
                        new
                        {
                            EnumRolePermissionId = 29,
                            Description = "Edit Animal Groups",
                            InternalName = "edit_animal_groups"
                        },
                        new
                        {
                            EnumRolePermissionId = 30,
                            Description = "View Animal Groups",
                            InternalName = "view_animal_groups"
                        },
                        new
                        {
                            EnumRolePermissionId = 31,
                            Description = "Use (create/edit) Group Scripts",
                            InternalName = "use_group_script"
                        });
                });
            ...
            modelBuilder.Entity("Business.Model.LifeEventDynamicFieldInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LifeEventDynamicFieldInfoId = 1073741823,
            ...
            modelBuilder.Entity("Business.Model.MapAnimalToAnimalGroup", b =>
                {
                    b.Property<int>("MapAnimalToAnimalGroupId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("MapAnimalToAnimalGroupId");

                    b.HasIndex("AnimalId");

                    b.HasIndex("AnimalGroupId", "AnimalId")
                        .IsUnique();

                    b.ToTable("MapAnimalToAnimalGroups");
                });
            ...
            modelBuilder.Entity("Business.Model.AnimalGroupScriptAutoEntry", b =>
                {
                    b.HasOne("Business.Model.AnimalGroup", "AnimalGroup")
                        .WithMany("AutomatedScripts")
                        .HasForeignKey("AnimalGroupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Business.Model.AnimalGroupScript", "AnimalGroupScript")
                        .WithMany("AutomatedScripts")
                        .HasForeignKey("AnimalGroupScriptId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Business.Model.ContactUnsubscribeEntry", b =>
                {
                    b.HasOne("Business.Model.Contact", "Contact")
                        .WithMany("UnsubscribedAddresses")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
